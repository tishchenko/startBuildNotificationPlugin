...
[@templateOuter baseUrl=baseUrl]
    ...
    [#if shortErrorSummary.size() gt 0]
        [@sectionHeader baseUrl "${baseUrl}/browse/${buildSummary.buildResultKey}/log" "Error Summary" "View full build log"/]
    ...
    [@showActions]
        [@addAction "View Online" "${baseUrl}/browse/${buildSummary.buildResultKey}" true/]
        [@addAction "Add Comments" "${baseUrl}/browse/${buildSummary.buildResultKey}?commentMode=true"/]
        [@addAction "View Artifacts" "${baseUrl}/browse/${buildSummary.buildResultKey}/artifact"/]
        [@addAction "Download Logs" "${baseUrl}/download/${buildSummary.buildKey}/build_logs/${buildSummary.buildResultKey}.log"/]
    [/@showActions]
